...
class TU_State_Manager extends TU_Request_Handler {
	...
	protected function state_bar( $current_design ) {
		...
		include TVE_Ult_Const::plugin_path() . 'editor/layouts/states.php';
	...
	public function render_ajax_content( $current_design ) {
		...
		ob_start();
		$is_ajax_render = true;
		include TVE_Ult_Const::plugin_path() . 'editor/layouts/campaign/' . TU_Template_Manager::type( $current_design[ TVE_Ult_Const::FIELD_TEMPLATE ] ) . '.php';
