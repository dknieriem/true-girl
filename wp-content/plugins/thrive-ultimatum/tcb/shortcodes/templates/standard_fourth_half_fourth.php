...
<div class="thrv_wrapper tcb-flex-row tcb--cols--3">
	...
	<div class="tcb-flex-col c-50"><p><?php echo sprintf( __( 'Column %s', 'thrive-cb' ), 2 ) ?></p></div>
	<div class="tcb-flex-col c-25"><p><?php echo sprintf( __( 'Column %s', 'thrive-cb' ), 3 ) ?></p></div>
</div>
