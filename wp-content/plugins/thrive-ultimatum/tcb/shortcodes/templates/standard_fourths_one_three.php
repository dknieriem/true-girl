...
<div class="thrv_wrapper thrv_columns tve_clearfix">
	<div class="tve_colm tve_foc tve_df tve_ofo"><p><?php echo sprintf( __( "Column %s", "thrive-cb" ), "1" ) ?></p></div>
...
<div class="thrv_wrapper tcb-flex-row tcb--cols--2">
	...
	<div class="tcb-flex-col c-75"><p><?php echo sprintf( __( 'Column %s', 'thrive-cb' ), 2 ) ?></p></div>
</div>
