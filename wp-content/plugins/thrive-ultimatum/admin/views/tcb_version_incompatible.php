...
<div class="tve-ult-notice-overlay">
	<div id="tve_ult_license_notice">
		...
		<p style="margin: 20px 0">
			<?php echo __( "It looks like you have Thrive Content Builder installed, but it's not compatible with this version of Thrive Ultimatum. Thrive Ultimatum uses Thrive Content Builder to edit various pieces of content.
To be able to use this feature, please make sure you have the latest versions for both plugins by clicking on the following link and checking for updates:", TVE_Ult_Const::T ) ?>
		...
		<p style="margin: 0;">
			<a class="tve-license-link"
			   href="<?php echo admin_url( 'plugins.php' ); ?>"><?php echo __( 'Manage plugins', TVE_Ult_Const::T ) ?></a>
		</p>
	</div>
</div>
<style type="text/css">
