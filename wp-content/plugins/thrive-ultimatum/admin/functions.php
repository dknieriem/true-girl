...
function tve_ult_admin_notice_wrong_tcb_version() {
	...
	$text = sprintf( __( 'Current version of Thrive Ultimatum is not compatible with the current version of Thrive Content Builder. Please update both plugins to the latest versions.', TVE_Ult_Const::T ) );
