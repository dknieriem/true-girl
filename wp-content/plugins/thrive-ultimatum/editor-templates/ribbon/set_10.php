...
<div
	...
	style="background-image: url('<?php echo TVE_Ult_Const::plugin_url( 'editor-templates/css/images/64_set_bg.png' ) ?>');background-position: left top;background-repeat: no-repeat;">
