...
?>
<div
	class="thrv_ult_bar tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tvu_set_15 tve_black"
	style="background-image: url('<?php echo TVE_Ult_Const::plugin_url( 'editor-templates/css/images/set_70_bg.jpg' ) ?>');background-position: center center;background-size:cover;">
