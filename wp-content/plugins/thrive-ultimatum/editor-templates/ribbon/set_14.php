...
?>
<div class="thrv_ult_bar tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tvu_set_14 tve_teal" style="background-image: url('<?php echo TVE_Ult_Const::plugin_url('editor-templates/css/images/set_68_bg.png') ?>');background-position: left top;background-repeat: no-repeat;">
		...
		<div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;margin-bottom: 0;">
			...
			<div class="tve_colm tve_oth tve_lst">
				<div class="thrv_wrapper thrv_button_shortcode tve_centerBtn" data-tve-style="1">
					<div class="tve_btn tve_btn3 tve_nb tve_blue tve_normalBtn" style="margin-top: 20px;">
