...
?>
<div class="thrv_ult_bar tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tvu_set_08 tve_blue" style="background-image: url('<?php echo TVE_Ult_Const::plugin_url('editor-templates/css/images/62_set_bg.png') ?>');background-position: center top;background-repeat: no-repeat;background-size: auto 100%;">
