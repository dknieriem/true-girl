		...
		<div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;margin-bottom: 0;">
				...
				<div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;margin-bottom: 0;">
					<div class="tve_colm tve_tth">
						...
						<p style="color: #fff; font-size:  17px;margin-top: 10px;margin-bottom: 0;">
							<span class="bold_text">Quick:</span> you can now get our top-selling product at a massive discount! But this offer will go away in:
						</p>
					</div>
			...
			<div class="tve_colm  tve_foc tve_ofo tve_df tve_lst">
				<div class="thrv_wrapper thrv_button_shortcode tve_centerBtn" data-tve-style="1">
					<div class="tve_btn tve_btn3 tve_nb tve_orange tve_normalBtn" style="">
