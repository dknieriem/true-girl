...
?>
<div class="thrv_ult_widget thrv_wrapper tve_no_drag tve_no_icons tve_element_hover tve_set_16 tve_black" style="background-image: url('<?php echo TVE_Ult_Const::plugin_url("editor-templates/css/images/69_set_bg_large.jpg") ?>'); background-size:cover; background-position: center bottom;">
