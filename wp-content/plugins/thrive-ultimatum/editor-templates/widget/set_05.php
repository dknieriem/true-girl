...
?>
<div class="thrv_ult_widget thrv_wrapper tve_no_drag tve_no_icons tve_element_hover tve_set_05 tve_red">
	<div class="tve-ult-widget-content tve_editor_main_content">
		<h5 class="tve_p_center tvu-heading" style="color: #000; font-size:  26px;margin-top: 15px;margin-bottom: 20px;">
