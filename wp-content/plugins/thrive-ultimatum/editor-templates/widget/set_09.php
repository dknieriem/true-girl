...
?>
<div class="thrv_ult_widget thrv_wrapper tve_no_drag tve_no_icons tve_element_hover tve_set_09 tve_blue">
	<div class="tve-ult-widget-content tve_editor_main_content">
		<h5 style="color: #fff; font-size: 30px;margin-top: 10px;margin-bottom: 20px;" class="tvu-heading tve_p_center">
			<font color="#e9b313">This Offer</font> <br> expires in:
		</h5>
		<div class="thrv_wrapper thrv_countdown_timer tve_cd_timer_plain tve_clearfix init_done tve_orange tve_countdown_2"
		...
		<div class="thrv_wrapper thrv_button_shortcode tve_centerBtn" data-tve-style="1">
			<div class="tve_btn tve_btn3 tve_nb tve_orange tve_normalBtn" style="margin-top: 40px;">
