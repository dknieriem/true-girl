...
?>
<div class="thrv_ult_widget thrv_wrapper tve_no_drag tve_no_icons tve_element_hover tve_set_01 tve_white" style="background-image: url('<?php echo TVE_Ult_Const::plugin_url("editor-templates/css/images/tvu_set1_widget_bg.jpg") ?>'); background-size:cover; background-position: center center;">
