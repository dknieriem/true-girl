...
?>
<div class="thrv_ult_widget thrv_wrapper tve_no_drag tve_no_icons tve_element_hover tve_set_10 tve_teal" style="background-image: url('<?php echo TVE_Ult_Const::plugin_url("editor-templates/css/images/64_set_bg.png") ?>');background-repeat: no-repeat; background-position: left top;">
	<div class="tve-ult-widget-content tve_editor_main_content">
		<h5 style="color: #040404; font-size: 30px;margin-top: 40px;margin-bottom: 20px;" class="tvu-heading tve_p_center">
		...
		<div class="thrv_wrapper thrv_button_shortcode tve_centerBtn" data-tve-style="1">
			<div class="tve_btn tve_btn3 tve_nb tve_black tve_normalBtn" style="margin-top: 40px;">
