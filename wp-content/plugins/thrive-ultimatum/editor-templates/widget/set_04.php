...
?>
<div class="thrv_ult_widget thrv_wrapper tve_no_drag tve_no_icons tve_element_hover tve_set_04 tve_blue">
	<div class="tve-ult-widget-content tve_editor_main_content">
		<h5 style="color: #fff; font-size: 26px;margin-top: 10px;margin-bottom: 20px;" class="tvu-heading tve_p_center">
			Get <span class="bold_text">50%</span> Off Before it's too Late!
		</h5>
		<p style="color: #fff; font-size:  18px;margin-top: 10px;margin-bottom: 10px;" class="tve_p_center">
		...
		<div class="thrv_wrapper thrv_button_shortcode tve_centerBtn" data-tve-style="1">
			<div class="tve_btn tve_btn3 tve_nb tve_orange tve_normalBtn" style="margin-top: 20px;">
				<a href="" class="tve_btnLink">
					...
					<span class="tve_btn_txt">GET THE OFFER NOW</span>
				</a>
			</div>
		</div>
	</div>
