...
?>
<div class="thrv_ult_widget thrv_wrapper tve_no_drag tve_no_icons tve_element_hover tve_set_06 tve_red" style="background-image: url('<?php echo TVE_Ult_Const::plugin_url("editor-templates/css/images/tvu_set_06_widget_bg.png") ?>'); background-size:cover; background-position: center bottom;">
	<div class="tve-ult-widget-content tve_editor_main_content">
		...
		<div class="thrv_wrapper thrv_button_shortcode tve_centerBtn" data-tve-style="1">
			<div class="tve_btn tve_btn3 tve_nb tve_white tve_normalBtn" style="margin-top: 40px;">
