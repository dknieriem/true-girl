...
?>
<div class="thrv_wrapper tve-tqb-page-type tqb-result-template-3 tve_editor_main_content tve_no_drag tve_clearfix" style="<?php echo $main_content_style; ?>">
	<h2 class="tve_p_center">Congratulations!</h2>
	<div class="tqb-social-share-badge-container tcb-no-url thrv_wrapper thrv_social">
		<div class="tve_social_items tve_social_custom tve_social_medium tve_social_itb tqb-social-share-buttons tve_style_1" id="tqb-set-2" data-value="set_02">
