...
<div class="thrv_wrapper tcb-flex-row tcb--cols--2">
	<div class="tcb-flex-col c-33"><p><?php echo sprintf( __( 'Column %s', 'thrive-cb' ), 1 ) ?></p></div>
	<div class="tcb-flex-col c-66"><p><?php echo sprintf( __( 'Column %s', 'thrive-cb' ), 2 ) ?></p></div>
</div>
