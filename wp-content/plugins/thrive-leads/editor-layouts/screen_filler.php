...
<div id="tve-leads-editor-replace">
	...
	<div class="tve-leads-screen-filler" <?php if ( $hide_form ): ?>style="display: none;"<?php endif; ?> id="open-me">
...
<?php if ( ! is_editor_page() ) : ?>
	<script type="text/javascript">
		jQuery( document ).ready( function () {
			/* trigger open_screen_filler */
			window.TL_Front && TL_Front.open_screen_filler( jQuery( '#open-me' ) );
		} );
	</script>
<?php endif ?>
