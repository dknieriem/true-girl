import { getWordPressErrorMessage, getWordPressErrorType, getJavascriptErrorMessage } from '../utils/utils'

function syncingConfigLiteSync() {
   return {
      type: 'success',
      stepText: 'Finished syncing',
      message: "Success! You've finished syncing with Shopify."
   }
}
