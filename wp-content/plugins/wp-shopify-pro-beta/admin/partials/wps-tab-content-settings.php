   ...
   <ul class="subsubsub wps-submenu">
      ...
      <li>
         <a class="wps-sub-section-link <?= $active_sub_nav === 'wps-admin-section-general' ? 'current' : '' ?>"
            href="#!" data-sub-section="wps-admin-section-general" title="General"><?php echo __('General', WPS_PLUGIN_TEXT_DOMAIN); ?></a> |
      </li>

      <li>
         <a class="wps-sub-section-link <?= $active_sub_nav === 'wps-admin-section-syncing' ? 'current' : '' ?>"
            href="#!" data-sub-section="wps-admin-section-syncing" title="Syncing"><?php echo __('Syncing', WPS_PLUGIN_TEXT_DOMAIN); ?></a> |
      </li>

      <li>
         <a class="wps-sub-section-link <?= $active_sub_nav === 'wps-admin-section-pricing' ? 'current' : '' ?>"
            href="#!" data-sub-section="wps-admin-section-pricing" title="Pricing"><?php echo __('Pricing', WPS_PLUGIN_TEXT_DOMAIN); ?></a> |
      </li>

      <li>
         <a class="wps-sub-section-link <?= $active_sub_nav === 'wps-admin-section-layout' ? 'current' : '' ?>"
            href="#!" data-sub-section="wps-admin-section-layout" title="Layout"><?php echo __('Layout', WPS_PLUGIN_TEXT_DOMAIN); ?></a> |
      </li>

      <li>
         <a class="wps-sub-section-link <?= $active_sub_nav === 'wps-admin-section-products' ? 'current' : '' ?>"
            href="#!" data-sub-section="wps-admin-section-products" title="Products"><?php echo __('Products', WPS_PLUGIN_TEXT_DOMAIN); ?></a> |
      </li>

      <li>
         <a class="wps-sub-section-link <?= $active_sub_nav === 'wps-admin-section-collections'
         ? 'current'
         : '' ?>" href="#!" data-sub-section="wps-admin-section-collections" title="Collections"><?php echo __('Collections', WPS_PLUGIN_TEXT_DOMAIN); ?></a> |
      </li>

      <!-- <li>
         <a class="wps-sub-section-link <?= $active_sub_nav === 'wps-admin-section-related'
         ? 'current'
         : '' ?>" href="#!" data-sub-section="wps-admin-section-related-products" title="Related Products"><?php echo __('Related Products', WPS_PLUGIN_TEXT_DOMAIN); ?></a> |
      </li> -->

      <li>
         <a class="wps-sub-section-link <?= $active_sub_nav === 'wps-admin-section-cart' ? 'current' : '' ?>" href="#!"
            data-sub-section="wps-admin-section-cart" title="Cart"><?php echo __('Cart', WPS_PLUGIN_TEXT_DOMAIN); ?></a> |
      </li>
   <?php /* @if NODE_ENV='pro' */ ?>
      <li>
         <a class="wps-sub-section-link <?= $active_sub_nav === 'wps-admin-section-search' ? 'current' : '' ?>" href="#!"
            data-sub-section="wps-admin-section-search" title="Search"><?php echo __('Search', WPS_PLUGIN_TEXT_DOMAIN); ?></a> |
      </li>
<?php /* @endif */ ?>
      <li>
         <a class="wps-sub-section-link <?= $active_sub_nav === 'wps-admin-section-checkout' ? 'current' : '' ?>"
            href="#!" data-sub-section="wps-admin-section-checkout" title="Checkout"><?php echo __('Checkout', WPS_PLUGIN_TEXT_DOMAIN); ?></a> |
      </li>

      <li>
         <a class="wps-sub-section-link <?= $active_sub_nav === 'wps-admin-section-plugin' ? 'current' : '' ?>"
            href="#!" data-sub-section="wps-admin-section-plugin" title="Plugin"><?php echo __('Plugin', WPS_PLUGIN_TEXT_DOMAIN); ?></a>
      </li>
    ...
    -->
      <div class="wps-admin-sub-section <?= $active_sub_nav === 'wps-admin-section-general' ? 'is-active' : '' ?>"
         ...
         <h2 class="wps-admin-section-heading">
            ...
            <?php esc_html_e('General ', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>
    ...
    -->
      <div class="wps-admin-sub-section <?= $active_sub_nav === 'wps-admin-section-syncing' ? 'is-active' : '' ?>"
         ...
         <h2 class="wps-admin-section-heading">
            ...
            <?php esc_html_e('Syncing ', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>
         ...
         <div class="wps-admin-section">
            ...
            <?php
          /* @if NODE_ENV='pro' */
          require_once plugin_dir_path(__FILE__) . 'settings/syncing/settings-syncing-webhooks-urls.php';
          /* @endif */
          ...
          /* @if NODE_ENV='pro' */
          require_once plugin_dir_path(__FILE__) . 'settings/syncing/settings-syncing-selective-sync.php';
          /* @endif */

          /* @if NODE_ENV='pro' */
          require_once plugin_dir_path(__FILE__) . 'settings/syncing/settings-syncing-by-collection.php';
...
?>
         ...
         <h2 class="wps-admin-section-heading">
            <span class="dashicons dashicons-art"></span> <?php esc_html_e('Currencies', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>

         <div class="wps-admin-section">

            <?php require_once plugin_dir_path(__FILE__) . 'settings/pricing/settings-pricing-local-currency-toggle.php';
// require_once plugin_dir_path( __FILE__ ) . 'settings/pricing/settings-pricing-local-currency-with-base.php';
?>
    ...
    -->
      <div class="wps-admin-sub-section <?= $active_sub_nav === 'wps-admin-section-layout' ? 'is-active' : '' ?>"
         ...
         <h2 class="wps-admin-section-heading">
            ...
            <?php esc_html_e('General Layout ', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>
...
?>
      ...
      <div class="wps-admin-sub-section <?= $active_sub_nav === 'wps-admin-section-products' ? 'is-active' : '' ?>"
        ...
        ?>
         ...
         <h2 class="wps-admin-section-heading">
            ...
            <?php esc_html_e('Content ', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>
        ...
        ?>
         ...
         <h2 class="wps-admin-section-heading">
            ...
            <?php esc_html_e('Featured Images ', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>
         ...
         <div class="wps-admin-section">
            ...
            <?php
          /* @if NODE_ENV='pro' */
          require_once plugin_dir_path(__FILE__) . 'settings/products/settings-products-images-show-zoom.php';
          /* @endif */
         ...
         <h2 class="wps-admin-section-heading">
            <span class="dashicons dashicons-format-image"></span>
            <?php esc_html_e('Thumbnail Images ', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>
    ...
    -->
      <div class="wps-admin-sub-section <?= $active_sub_nav === 'wps-admin-section-collections' ? 'is-active' : '' ?>"
        ...
        ?>
         ...
         <h2 class="wps-admin-section-heading">
            <span class="dashicons dashicons-format-image"></span>
            <?php esc_html_e('Images ', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>
    ...
    -->
      <div
         ...
         <h2 class="wps-admin-section-heading">
            ...
            <?php esc_html_e('Related Products ', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>
    ...
    -->
      <div class="wps-admin-sub-section <?= $active_sub_nav === 'wps-admin-section-cart' ? 'is-active' : '' ?>"
         ...
         <h2 class="wps-admin-section-heading">
            <span class="dashicons dashicons-admin-settings"></span> <?php esc_html_e('Functionality', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>
         ...
         <div class="wps-admin-section">
            ...
            require_once plugin_dir_path(__FILE__) . 'settings/cart/settings-cart-enable-notes.php';
            require_once plugin_dir_path(__FILE__) . 'settings/cart/settings-cart-notes-placeholder.php';
          ?>
...
<!--
    ...
    -->
    <?php /* @if NODE_ENV='pro' */ ?>
      <div class="wps-admin-sub-section <?= $active_sub_nav === 'wps-admin-section-search' ? 'is-active' : '' ?>"
         id="wps-admin-section-search">

         <h2 class="wps-admin-section-heading">
            <span class="dashicons dashicons-search"></span> <?php esc_html_e('Search', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>

         <div class="wps-admin-section">

            <?php
          require_once plugin_dir_path(__FILE__) . 'settings/search/settings-search-by.php';
          require_once plugin_dir_path(__FILE__) . 'settings/search/settings-search-exact-match.php';
          ?>
    ...
    -->
      <div class="wps-admin-sub-section <?= $active_sub_nav === 'wps-admin-section-plugin' ? 'is-active' : '' ?>"
         ...
         <h2 class="wps-admin-section-heading">
            ...
            <?php esc_html_e('Plugin ', WPS_PLUGIN_TEXT_DOMAIN); ?>
         </h2>
      ...
      <!-- Nonce -->
      <input hidden type="text" class="regular-text" id="<?= WPS_SETTINGS_GENERAL_OPTION_NAME ?>_urls_nonce_id"
         name="<?= WPS_SETTINGS_GENERAL_OPTION_NAME ?>[wps_general_nonce]" value="<?php echo wp_create_nonce(
              uniqid()
); ?>" />
