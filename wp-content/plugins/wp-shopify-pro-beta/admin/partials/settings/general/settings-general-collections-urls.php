    ...
    <tbody>
      <tr valign="top">
        <th scope="row" class="titledesc">
          ...
          <span class="wps-help-tip" title="<?php esc_attr_e('Determines the default collections page slug. Your permalinks must be set to "Post name" for this URL to work. You can set this by going to `Settings -> Permalinks`.', WPS_PLUGIN_TEXT_DOMAIN ); ?>"></span>
        </th>
