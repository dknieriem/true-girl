    ...
    <tbody>
      ...
      <tr valign="top" class="wps-checkbox-row">
        ...
        <th scope="row" class="titledesc wps-checkbox-row-label">
          <?php esc_attr_e( 'Enable custom domain', WPS_PLUGIN_TEXT_DOMAIN ); ?>
          <span class="wps-help-tip" title="<?php esc_attr_e( 'When enabled, will use your custom primary domain (e.g., yourstore.com) when redirecting to the checkout page instead of the default .myshopify.com domain.', WPS_PLUGIN_TEXT_DOMAIN ); ?>"></span>
        </th>
