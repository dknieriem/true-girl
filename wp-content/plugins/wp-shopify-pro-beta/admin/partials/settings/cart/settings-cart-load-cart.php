    ...
    <tbody>
      <tr valign="top">
        ...
        <th scope="row" class="titledesc">
          ...
          <span class="wps-help-tip" title="<?php esc_attr_e( 'When this is turned off, the default cart experience will not load. Useful if you plan on linking products to Shopify directly.', WPS_PLUGIN_TEXT_DOMAIN ); ?>"></span>
        </th>
