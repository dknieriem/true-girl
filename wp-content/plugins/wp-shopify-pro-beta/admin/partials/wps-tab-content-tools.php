...
<div class="tab-content <?php echo $active_tab === 'tab-tools' ? 'tab-content-active' : ''; ?>" data-tab-content="tab-tools">
  ...
  <div class="wps-admin-section">
    ...
    <h3><?php esc_html_e('Reconnect Automatic Syncing', WPS_PLUGIN_TEXT_DOMAIN); ?></h3>
    <p><?php esc_html_e('This will reconnect the Shopify webhooks which are responsible for the automatic sync feature. Useful if you notice your data not auto syncing correctly or if you\'ve upgraded from the free version.', WPS_PLUGIN_TEXT_DOMAIN); ?></p>
    ...
    <div class="wps-button-group button-group button-group-ajax <?= $has_connection ? 'wps-is-active' : 'wps-is-not-active'; ?>">
      ...
      submit_button(esc_html__('Reconnect Automatic Syncing', WPS_PLUGIN_TEXT_DOMAIN), 'primary', 'submitSettings', false, $props); ?>
