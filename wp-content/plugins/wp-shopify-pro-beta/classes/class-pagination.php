			...
			if ($max_pages === 1) {
				...
				*/
				foreach ($range_numbers as $page_number) {
					...
					if ($page_number == $current_page) {
						...
						])->get_template_part( 'components/pagination/page-number', 'current');
						...
						$this->Templates->Template_Loader->set_template_data([
							'page_number' => $page_number,
							'page_href' 	=> $page_href
						])->get_template_part( 'components/pagination/page', 'number');
				...
				*/
				if ($current_page !== 1) {
					...
					])->get_template_part( 'components/pagination/page', 'previous');
				...
				*/
				if ($current_page !== $max_pages) {
					...
					])->get_template_part( 'components/pagination/page', 'next');
				...
				*/
				if (!in_array( 1, $range_numbers)) {
					...
					])->get_template_part( 'components/pagination/page', 'first');
				...
				*/
				if (!in_array($max_pages, $range_numbers)) {
					...
					])->get_template_part( 'components/pagination/page', 'last');
				...
				$this->Templates->Template_Loader->set_template_data([
					...
					'max_pages' 				=> $max_pages
				])->get_template_part( 'components/pagination/counter' );
