...
class Settings_General extends \WPS\DB
{
   ...
   public $default_search_exact_match;
    ...
    public function __construct()
    {
        ...
        $this->default_products_images_show_zoom = WPS_DEFAULT_PRODUCTS_IMAGES_SHOW_ZOOM;

        $this->default_products_thumbnail_images_sizing_toggle = 1;
        $this->default_products_thumbnail_images_sizing_width = WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_WIDTH;
        $this->default_products_thumbnail_images_sizing_height = WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_HEIGHT;
        $this->default_products_thumbnail_images_sizing_crop = WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_CROP;
        $this->default_products_thumbnail_images_sizing_scale = WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_SCALE;
