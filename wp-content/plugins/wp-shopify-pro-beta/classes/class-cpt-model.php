...
class CPT_Model
{
   ...
   public function build_products_model_for_update($all_products, $product, $menu_order = 0)
   {
      ...
      $product_model = $this->set_existing_product_categories($post_id, $product_model);
      $product_model = $this->set_existing_product_excerpt($post_id, $product_model);
      $product_model = $this->set_existing_custom_fields($post_id, $product_model);
