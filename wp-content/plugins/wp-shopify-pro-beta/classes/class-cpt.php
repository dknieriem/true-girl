...
class CPT {
	...
	*/
	public function post_type_products() {
		...
		register_post_type(WPS_PRODUCTS_POST_TYPE_SLUG, apply_filters('wps_register_products_args', $args));
	...
	*/
	...
	// 	if (post_type_exists(WPS_ORDERS_POST_TYPE_SLUG)) {
	// 		return;
   //    }

	// 	$labels = [
	// 		'name'                => _x('Orders', 'Post Type General Name', WPS_PLUGIN_TEXT_DOMAIN),
	// 		'singular_name'       => _x('Order', 'Post Type Singular Name', WPS_PLUGIN_TEXT_DOMAIN),
	// 		'menu_name'           => __('Orders', WPS_PLUGIN_TEXT_DOMAIN),
	// 		'parent_item_colon'   => __('Parent Item:', WPS_PLUGIN_TEXT_DOMAIN),
	// 		'new_item'            => __('Add New Order', WPS_PLUGIN_TEXT_DOMAIN),
	// 		'edit_item'           => __('Edit Order', WPS_PLUGIN_TEXT_DOMAIN),
	// 		'not_found'           => __('No Orders found', WPS_PLUGIN_TEXT_DOMAIN),
	// 		'not_found_in_trash'  => __('No Orders found in trash', WPS_PLUGIN_TEXT_DOMAIN)
	// 	];

	// 	$args = [
	// 		'label'               => __('Orders', WPS_PLUGIN_TEXT_DOMAIN),
	// 		'description'         => __('Custom Post Type for Orders', WPS_PLUGIN_TEXT_DOMAIN),
	// 		'labels'              => $labels,
	// 		'supports'            => array('title', 'page-attributes', 'editor', 'custom-fields', 'comments', 'thumbnail'),
	// 		'taxonomies'					=> ['category'],
	// 		'hierarchical'        => false,
   ...
   //    ];
	...
	// 	register_post_type(WPS_ORDERS_POST_TYPE_SLUG, apply_filters('wps_register_orders_args', $args));
	...
	*/
	public function post_type_collections() {
		...
		register_post_type(WPS_COLLECTIONS_POST_TYPE_SLUG, apply_filters('wps_register_collections_args', $args));
