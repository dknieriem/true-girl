...
class General extends \WPS\API
{
    ...
    public function update_settings($request)
    {
        ...
        $new_settings['products_thumbnail_images_sizing_toggle'] = $this->setting_to_bool_int($settings, 'wps_settings_products_thumbnail_images_sizing_toggle');
        ...
        $new_settings['products_thumbnail_images_sizing_scale'] = $this->setting_to_string($settings, 'wps_settings_products_thumbnail_images_sizing_scale', WPS_DEFAULT_PRODUCTS_IMAGES_SIZING_SCALE);
        ...
        $new_settings['related_products_images_sizing_scale'] = $this->setting_to_string(
          $settings,
          'wps_settings_related_products_images_sizing_scale',
          WPS_DEFAULT_RELATED_PRODUCTS_IMAGES_SIZING_SCALE
      );
        ...
        $new_settings['is_lite_sync'] = $this->setting_to_bool_int($settings, 'wps_settings_is_lite_sync');
        $new_settings['is_syncing_posts'] = $this->setting_to_bool_int($settings, 'wps_settings_is_syncing_posts');
        ...
        $new_settings['disable_default_pages'] = $this->setting_to_bool_int($settings, 'wps_settings_general_disable_default_pages');

        /* @if NODE_ENV='pro' */

        $new_settings['sync_by_collections'] = $this->setting_to_serialize($settings, 'wps_settings_general_sync_by_collections');
        $new_settings['url_webhooks'] = $this->setting_to_url($settings, 'wps_settings_general_url_webhooks');

        $new_settings['selective_sync_all'] = $this->setting_to_bool_int($settings, 'wps_settings_selective_sync_all', 1);
         $new_settings['selective_sync_shop'] = $this->setting_to_bool_int($settings, 'wps_settings_selective_sync_shop', 1);
         $new_settings['selective_sync_products'] = $this->setting_to_bool_int($settings, 'wps_settings_selective_sync_products');
         $new_settings['selective_sync_collections'] = $this->setting_to_bool_int($settings, 'wps_settings_selective_sync_collections');
         // $new_settings['selective_sync_tags'] = $this->setting_to_bool_int($settings, 'wps_settings_selective_sync_tags');
         $new_settings['selective_sync_customers'] = $this->setting_to_bool_int($settings, 'wps_settings_selective_sync_customers');
         $new_settings['selective_sync_orders'] = $this->setting_to_bool_int($settings, 'wps_settings_selective_sync_orders');
         // $new_settings['selective_sync_all'] = $this->massage_selective_sync($new_settings);



      //   $new_settings['pricing_local_currency_toggle'] = $this->setting_to_bool_int($settings, 'wps_settings_pricing_local_currency_toggle');
        $new_settings['pricing_local_currency_with_base'] = $this->setting_to_bool_int($settings, 'wps_settings_pricing_local_currency_with_base');

        $new_settings['products_images_show_zoom'] = $this->setting_to_bool_int($settings, 'wps_settings_products_images_show_zoom');

        $new_settings['search_by'] = $this->setting_to_string($settings, 'wps_settings_search_by');

        $new_settings['search_exact_match'] = $this->setting_to_bool_int($settings, 'wps_settings_search_exact_match');
        ...
        $new_settings['align_height'] = $this->setting_to_bool_int($settings, 'wps_settings_general_align_height');
