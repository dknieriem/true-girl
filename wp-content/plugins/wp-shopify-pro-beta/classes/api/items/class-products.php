...
class Products extends \WPS\API
{
   ...
   {
      return $this->Shopify_API->get_products_per_page($this->get_published_product_ids_as_param($current_page), $this->DB_Settings_General->get_items_per_request());
   }
   ...
   {
      return register_rest_route(WPS_SHOPIFY_API_NAMESPACE, '/products/tags', [
         [
   ...
   */
   ...
   {
      return register_rest_route(WPS_SHOPIFY_API_NAMESPACE, '/products/vendors', [
         [
            'methods' => \WP_REST_Server::READABLE,
   ...
   */
   ...
   {
      return register_rest_route(WPS_SHOPIFY_API_NAMESPACE, '/products/types', [
         [
            'methods' => \WP_REST_Server::READABLE,
