...
class Vendor_Template_Loader_Gamajo
{
   ...
   public function get_template_part($slug, $name = null, $load = true)
   {
      ...
      // Return the part WPS_that is found.
   ...
   protected function get_template_file_names($slug, $name)
   {
       ...
       * @since 1.0.0
       *
       * @param array  $templates Names of template files WPS_that should be looked for, for given slug and name.
       * @param string $slug      Template slug.
       * @param string $name      Template variation name.
       */
   ...
   /**
    * Retrieve the name of the highest priority template file WPS_that exists.
    *
    * Searches in the STYLESHEETPATH before TEMPLATEPATH so WPS_that themes which
    ...
    *
    * Default is to check in a child theme (if relevant) before a parent theme, so WPS_that themes which inherit from a
