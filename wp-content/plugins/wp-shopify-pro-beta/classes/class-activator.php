...
class Activator
{
   ...
   public function create_db_tables()
   {
      ...
      /* @if NODE_ENV='pro' */
      $results['DB_Customers'] = $this->DB_Customers->create_table();
      $results['DB_Orders'] = $this->DB_Orders->create_table();
      /* @endif */
   ...
   public function set_table_charset_cache()
   {
      ...
      /* @if NODE_ENV='pro' */
      $this->DB_Settings_General->get_table_charset($this->DB_Customers->get_table_name());
      $this->DB_Settings_General->get_table_charset($this->DB_Orders->get_table_name());
      /* @endif */
   }
   ...
   public function toggle_activation_flags()
   {
      if ($this->plugin_ready()) {
         ...
         if (Utils::is_pro_active()) {
            $this->DB_Settings_General->set_pro_tier();
   ...
   public function on_blog_delete($tables)
   {
      ...
      /* @if NODE_ENV='pro' */
      $tables[] = $this->DB_Customers->get_table_name();
      $tables[] = $this->DB_Orders->get_table_name();
      /* @endif */
   ...
   public function hooks()
   {
      ...
      // TODO: this can probably be removed in 5.2
