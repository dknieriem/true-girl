...
class Config
{
   ...
   public function __construct()
   {
      ...
      $this->plugin_root_file_name = 'wp-shopify';      
      ...
      $this->plugin_root_file = $this->plugin_dir_path . $this->plugin_root_file . '.php';
      $this->plugin_free_root_file = WP_PLUGIN_DIR . '/' . $this->plugin_free_folder_name . '/' . $this->plugin_root_file . '.php';
      $this->plugin_pro_root_file = WP_PLUGIN_DIR . '/' . $this->plugin_pro_folder_name . '/' . $this->plugin_root_file . '.php';

      $this->plugin_pro_subdirectory_name = $this->plugin_pro_folder_name . '/' . $this->plugin_root_file . '.php';
      $this->plugin_free_subdirectory_name = $this->plugin_free_folder_name . '/' . $this->plugin_root_file . '.php';

      $this->plugin_file = plugin_basename($this->plugin_root_file);
      $this->plugin_basename = plugin_basename($this->plugin_dir_path . $this->plugin_root_file . '.php');
      ...
      if (!defined('WPS_ORDERS_POST_TYPE_SLUG')) {
         define('WPS_ORDERS_POST_TYPE_SLUG', $this->orders_post_type_slug);
      }   
      ...
      if (!defined('WPS_DEFAULT_PRODUCTS_IMAGES_SHOW_ZOOM')) {
         define('WPS_DEFAULT_PRODUCTS_IMAGES_SHOW_ZOOM', $this->plugin_default_products_images_show_zoom);
      }


      if (!defined('WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_WIDTH')) {
         define('WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_WIDTH', $this->plugin_default_products_thumbnail_images_sizing_width);
      }

      if (!defined('WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_HEIGHT')) {
         define('WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_HEIGHT', $this->plugin_default_products_thumbnail_images_sizing_height);
      }

      if (!defined('WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_CROP')) {
         define('WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_CROP', $this->plugin_default_products_thumbnail_images_sizing_crop);
      }

      if (!defined('WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_SCALE')) {
         define('WPS_DEFAULT_PRODUCTS_THUMBNAIL_IMAGES_SIZING_SCALE', $this->plugin_default_products_thumbnail_images_sizing_scale);
      }
