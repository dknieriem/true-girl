...
class Bootstrap
{
   ...
   public static function plugin_build()
   {
      ...
      $results['Shortcodes_Hooks'] = Factories\Shortcodes\Shortcodes_Factory::build();

      // $results['Render_Products_Hooks'] = Factories\Render\Products\Hooks_Factory::build();
      $results['API_Options_Components_Factory'] = Factories\API\Options\Components_Factory::build();
      $results['API_Items_Products_Factory'] = Factories\API\Items\Products_Factory::build();
         ...
         /* @if NODE_ENV='pro' */
         $results['Webhooks'] = Factories\Webhooks_Factory::build();

         $results['API_Items_Webhooks_Factory'] = Factories\API\Items\Webhooks_Factory::build();
         $results['API_Items_Orders_Factory'] = Factories\API\Items\Orders_Factory::build();
         $results['API_Items_Customers_Factory'] = Factories\API\Items\Customers_Factory::build();
         $results['API_Processing_Orders_Factory'] = Factories\API\Processing\Orders_Factory::build();
         $results['API_Processing_Customers_Factory'] = Factories\API\Processing\Customers_Factory::build();

         $results['API_Processing_Webhooks_Factory'] = Factories\API\Processing\Webhooks_Factory::build();
         $results['API_Processing_Webhooks_Deletions_Factory'] = Factories\API\Processing\Webhooks_Deletions_Factory::build();
         /* @endif */
