...
class Migrations {
	...
	*/
	public function create_migration_db_tables($table_suffix) {
		...
		/* @if NODE_ENV='pro' */
		$create_migration_db_tables_results['DB_Customers'] = $this->DB_Customers->create_migration_table($table_suffix);
		$create_migration_db_tables_results['DB_Orders'] = $this->DB_Orders->create_migration_table($table_suffix);
		/* @endif */
	...
	*/
	public function run_insert_to_queries() {
		...
		/* @if NODE_ENV='pro' */
		$insert_to_queries_results['DB_Customers'] = $this->customers_insert_into_query();
		$insert_to_queries_results['DB_Orders'] = $this->orders_insert_into_query();
		/* @endif */
	...
	public function delete_old_tables() {
		...
		/* @if NODE_ENV='pro' */
		$delete_old_tables_results['DB_Customers'] = $this->DB_Customers->delete_table();
		$delete_old_tables_results['DB_Orders'] = $this->DB_Orders->delete_table();
		/* @endif */
	...
	public function rename_migration_tables() {
		...
		/* @if NODE_ENV='pro' */
		$rename_migration_tables_results['DB_Customers'] = $this->DB_Customers->rename_migration_table();
		$rename_migration_tables_results['DB_Orders'] = $this->DB_Orders->rename_migration_table();
		/* @endif */
	...
	public function hooks() {
		...
		add_action('wp_ajax_nopriv_run_table_migration', [$this, 'run_table_migration']);
