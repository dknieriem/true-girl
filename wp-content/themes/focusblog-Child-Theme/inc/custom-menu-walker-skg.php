...
class skg_custom_menu_walker extends Walker_Nav_Menu {
		...
		if ( $depth == 2 && $item->extended_text_chk == 'on' ) {
			...
			$item_output .= $args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after;
			  if (in_array('menu-item-has-children', $item->classes)) {
				$item_output .='<span class="caret"><i class="dropdown-indicator"></i></span></a>';
			} else {
				$item_output .= '</a>';
			}
		}
...
function skg_function_admin_custom_menu_walker( $walker, $menu_id ) {
	return 'skg_admin_custom_menu_walker';
}

class skg_admin_custom_menu_walker extends Walker_Nav_Menu {
