...
<head>
	...
	})(window,document,'script','dataLayer','GTM-KFRL8WG');</script>
	<!-- End Google Tag Manager -->

	<link href="https://fonts.googleapis.com/css?family=Bigelow+Rules|Crushed" rel="stylesheet"><!-- Google Font -->
...
<body <?php body_class() ?>>
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KFRL8WG"
...
<?php
	if ( file_exists( dirname( __FILE__ ) . '/social-header.php' ) ) {
		include( dirname( __FILE__ ) . '/social-header.php' );
	}
?>

<?php //begin conditional header
	if ( file_exists( dirname( __FILE__ ) . '/nav-header.php' ) ) {
		include( dirname( __FILE__ ) . '/nav-header.php' );
	}
