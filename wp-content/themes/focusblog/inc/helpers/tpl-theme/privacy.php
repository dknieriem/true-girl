...
<p><?php echo $options['website'] ?> may contain links to many other websites. <?php echo $options['company'] ?> cannot
	...
	controlled by <?php echo $options['company'] ?> do not constitute an endorsement
	by <?php echo $options['company'] ?> or any of its employees of the sponsors of these sites or the products or
...
<p><?php echo $options['company'] ?> is not responsible for any of the opinions or comments posted
	on <?php echo $options['website'] ?>. <?php echo $options['company'] ?> is not a forum for testimonials, however
	provides testimonials as a means for customers to share their experiences with one another. To protect against
	abuse, all testimonials appear after they have been reviewed by management of <?php echo $options['company'] ?>
	. <?php echo $options['company'] ?> doe not share the opinions, views or commentary of any testimonials
	on <?php echo $options['website'] ?> - the opinions are strictly the views of the testimonial source.</p>
...
<p>For site security purposes and to ensure that this service remains available to all
	users, <?php echo $options['company'] ?> uses software programs to monitor network traffic to identify unauthorized
...
<p>All the materials on this site are provided 'as is' without any express or implied warranty of any kind, including
	...
	death) arising out of the use of or inability to use the materials, even if <?php echo $options['company'] ?> has
