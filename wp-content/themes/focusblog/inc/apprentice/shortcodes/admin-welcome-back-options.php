<table class="form-table postEdit">
	...
	<tr>
		...
		<td>
			<textarea
				id="thrive_shortcode_option_box_headline"><?php _e( "Welcome back, {NamePlaceholder}! Click here to continue where you left off!", 'thrive' ); ?></textarea>
		</td>
	</tr>
	<tr>
		<th scope="row">
		...
		<td>
			<textarea
				id="thrive_shortcode_message_start"><?php _e( "Hello, {NamePlaceholder}! Click here to get started!", 'thrive' ); ?></textarea>
		</td>
	</tr>
	<tr>
		<td></td>
