...
class Thrive_Appr_Favorites extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$default_text = isset( $instance['default_text'] ) && ! empty( $instance['default_text'] )
			? $instance['default_text'] : __( 'Lessons you mark as your favorites will be listed here.', 'thrive' );
		?>

		<section class="wat appr-w">
			<div class="scn">
	...
	function form( $instance ) {
		...
		$default_text = isset( $instance['default_text'] ) && ! empty( $instance['default_text'] ) ? esc_attr( $instance['default_text'] ) : __( 'Lessons you mark as your favorites will be listed here.', 'thrive' );
