							...
							<?php foreach ( $modules as $m ): ?>
								<li class="module_item thrive-appr-tree">
									<div class="app-content">
										<div class="app-toggle">
											<span class="app-toggle-dmy"></span>
											<input type="hidden" class="thrive_hidden_term_id"
											       value="<?php echo $m['term_id']; ?>"/>
	...
	<div class="twc right">
		<div class="apbox">
			...
			<form action="">
				...
				<textarea id="thrive_appr_txt_cat_description" autocomplete="off"
				          placeholder="<?php _e( "Description", 'thrive' ); ?>"></textarea>

				<div class="clear"><br/></div>
				<input type="submit" value="<?php _e( "Add New Category", 'thrive' ); ?>"
				       id="btn_thrive_appr_add_new_cat"/>
			...
			<div class="apbox">
				<form action="">
					...
					<input type="submit" value="<?php _e( "Set", 'thrive' ); ?>"
					       id="btn_thrive_appr_set_lessons_level"/>
