...
(function () {
    tinymce.PluginManager.add("thrivev2_tc_button2", function (b, a) {
        b.addButton("thrivev2_tc_button2", {
            title: "ThriveColumns",
            type: "menubutton",
...
thrive_add_tinymce_sc_button2_style = function () {
    var a = ThriveThemeUrl + "/inc/images/thrive-shortcode-2.png";
    jQuery(".thrivev2-columns-icon").css({"background-image": "url('" + a + "')"})
};
